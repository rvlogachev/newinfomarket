...
//        ]));
        ...
        $id = Yii::$app->queue->push(new \common\modules\queuemanager\components\DownloadJob([
            'url' => 'http://example.com/image.jpg',
            'file' => '/tmp/image.jpg',
        ]));
...
//        ]));
     ...
     //  print_r( \common\modules\chat\components\Helper::CreateScope( ));
     // print_r( \common\modules\chat\components\Helper::CreateAccount( ));

        $txtjson = \GuzzleHttp\json_encode(['type'=>'typing','message'=>'yes']);
        $sentSuccess = Yii::$app->commandBus->handle(new \common\modules\queuemanager\commands\command\SendSocketCommand([

            'message' => $txtjson,
            'user' => '06457231ddb941103301fba4da8891e0'
        ]));
