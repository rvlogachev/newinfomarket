...
<article class="blogpost">
    ...
    <div class="blogpost-content">
        <div class="time-wrap">
                    ...
                    <a href="#" class="time-send" data-showname="Прочту" data-hidename="Нет времени читать?">Нет времени читать?</a>
                    <a href="#" class="time-send small" data-showname="Прочту" data-hidename="Нет времени">Нет времени?</a>
