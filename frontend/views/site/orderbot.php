    ...
    <div class="container">
        <div class="row">
            ...
            <div class="main col-12">
                ...
                <!-- page-title start -->
                <!-- ================ -->
                <h1 class="page-title text-center">Мы рады сотрудничеству</h1>
                <!-- page-title end -->
                        ...
                        <div class="col-lg-6">
                            <div class="body">
                                ...
                                <p class="margin-clear">
                                    Вы также можете почитать статьи о чат ботах и сфере в целом в нашем блоге.
                                </p>
                                <br>
                                <a href="/blog" class="btn btn-danger   btn-lg" style="">
