...
<section id="intro-hero hero-content" style="   height: 650px; background: url(<?= $bundlePath;?>/images/front_img2.png) no-repeat scroll 0 0; background-position: 0px;  background-size: cover; padding-top: -100px;display: block; box-shadow: 0 0 0 330px rgba(0, 0, 0, 0.6) inset; ">
    <div class="container-fluid">
        <div class="row" style="padding-top: 80px;">
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <p class="hero-tagline top-15" style="color:white;  font-size:20px">
...
<section class="pv-30">
    ...
    <div class="owl-carousel content-slider-with-large-controls">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="" src="<?= $bundlePath;?>/images/ascending-graph.jpg" alt="">
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="<?= $bundlePath;?>/images/sait-dlya-telefona.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="pv-30"  >
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h2 class="text-center"><strong>Какие инструменты мы используем</strong></h2>
                <div class="separator"></div>
                <p class="large text-center">
                        ...
                        <div class="convertation"  >
                            ...
                            <div class="row">
                                ...
                                <div class="container-fluid">
                                    <p class="large text-center hidden-xs"
                                       style="font-size:16px;font-weight: normal;padding-left:15%;padding-right:15%;padding-top:15px;">
                                        Повышаем конверсию, улучшаем показатели в аналитике, интегрируем необходимые сервисы
                                        и конвертируем лидов в клиентов
                                    </p>
                                </div>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="marketing">
                            <div class="overlay-container overlay-visible">
                                <img src="<?= $bundlePath;?>/images/marketinf_bi.png" alt="">
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade " id="klienti">
                            <div class="overlay-container overlay-visible">
                                <img src="<?= $bundlePath;?>/images/klienti.png" alt="">
                        ...
                        <div role="tabpanel" class="tab-pane fade " id="sale">
                            <div class="overlay-container overlay-visible">
                                <img src="<?= $bundlePath;?>/images/sale.png" alt="">
                                <a class="overlay-link"> </a>
                        ...
                        <div role="tabpanel" class="tab-pane fade " id="finance">
                            <div class="overlay-container overlay-visible">
                                <img src="<?= $bundlePath;?>/images/finance.png" alt="">
                                <a class="overlay-link"> </a>
...
<!--                </div>-->
                <div class="client-image">
                    <a href="#"><img src="<?= $bundlePath;?>/images/client-3.png" alt=""></a>
                </div>
                <div class="client-image">
                    <a href="#"><img src="<?= $bundlePath;?>/images/client-4.png" alt=""></a>
                </div>
                <div class="client-image">
                    <a href="#"><img src="<?= $bundlePath;?>/images/client-5.png" alt=""></a>
                </div>
                <div class="client-image">
                    <a href="#"><img src="<?= $bundlePath;?>/images/client-6.png" alt=""></a>
                </div>
                <div class="client-image">
                    <a href="#"><img src="<?= $bundlePath;?>/images/client-7.png" alt=""></a>
                </div>
                <div class="client-image">
                    <a href="#"><img src="<?= $bundlePath;?>/images/client-8.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
...
<section id="intro-hero hero-content" style="height: 650px; background: url(<?= $bundlePath;?>/images/portfolio-slider-slide-1.jpg) no-repeat scroll 0 0; background-position: 0px;  background-size: cover; padding-top: -100px;display: block;">
    <div class="container-fluid">
        <div class="row" style="padding-top: 80px;">
            ...
            <div class="col-md-5 col-sm-6 hidden-xs">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <img src="<?= $bundlePath;?>/images/pdf.gif" style="padding-top:13px;">
                    </div>
                </div>
...
<section class="dark-translucent-bg parallax pv-30"
         style="background-image:url(<?= $bundlePath;?>/images/corporate-5-section-image-2.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="text-center">
                        <div class="col-md-3 text-center">
                            <img   class="imgpartnersya" src="<?= $bundlePath;?>/images/yandex.png" alt="">
                        </div>
                        <div class="col-md-3 text-center">
                            <img   class="imgpartnersgoogle" src="<?= $bundlePath;?>/images/google.png" alt="">
                        </div>
                        <div class="col-md-3 text-center">
                            <img    class="imgpartners"  src="<?= $bundlePath;?>/images/sc.png" alt="">
                        </div>
                        <div class="col-md-3 text-center">
                            <img   class="imgpartners"  src="<?= $bundlePath;?>/images/microsoft.png" alt="">
                        </div>
                        ...
                        <div class="sidebar">
                            <div class="block clearfix">
                                ...
                                <ul class="list">
                                    ...
                                    <li>
                                        <i class="fa fa-phone pr-10 text-default"></i><a style="color: #777777; font-size: 18px;font-family:Arial,sans-serif !important; href="tel:+74951331649">
                                            +7(495) 133-16-49
                                        </a>
                                    </li>
                                    <li>
